...
export function createSoundTouchEngine(
  ...
  // ✅ ВАЖНО: не типизируем PitchShifter как тип — у soundtouchjs кривые d.ts
  let shifter: any = null
  ...
  const rebuildShifter = () => {
    ...
    shifter = new (PitchShifter as any)(audioCtx, currentBuffer, bufferSize)
